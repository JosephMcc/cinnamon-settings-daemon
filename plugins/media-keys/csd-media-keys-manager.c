...
do_eject_action (CsdMediaKeysManager *manager)
{
        ...
        /* Show the dialogue */
        show_osd (manager, "media-eject-symbolic", -1, -1);
                              ...
                              const char          *key)
{
        ...
        if (!have_listeners) {
                ...
                /* Popup a dialog with an (/) icon */
                    show_osd (manager, "action-unavailable-symbolic", -1, -1);
                 }
                return TRUE;
        }
                    ...
                    gpointer             user_data)
{
        ...
        show_osd (manager, "keyboard-brightness-symbolic", percentage, -1);
